...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_microsoft_notes_ui_note_engine_WhisperEngineNative_createTFLiteEngine(JNIEnv *env,
                                                                               jobject thiz) {
    return reinterpret_cast<jlong>(new TFLiteEngine());
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_microsoft_notes_ui_note_engine_WhisperEngineNative_loadModel(JNIEnv *env, jobject thiz,
                                                                      jlong nativePtr,
                                                                      jstring modelPath,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_microsoft_notes_ui_note_engine_WhisperEngineNative_freeModel(JNIEnv *env, jobject thiz,
                                                                      jlong nativePtr) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
    engine->freeModel();
    delete engine;
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_microsoft_notes_ui_note_engine_WhisperEngineNative_transcribeBuffer(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jlong nativePtr,
                                                                             jfloatArray samples) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_microsoft_notes_ui_note_engine_WhisperEngineNative_transcribeFile(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jlong nativePtr,
                                                                           jstring waveFile) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
